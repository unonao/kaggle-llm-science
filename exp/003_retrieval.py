...
def main(c: DictConfig) -> None:
    ...
    df_train["prompt"] = df_train["context"].str.slice(0, cfg.max_length) + " #### " + df_train["prompt"]
    df_valid["prompt"] = df_valid["context"].str.slice(0, cfg.max_length) + " #### " + df_valid["prompt"]
