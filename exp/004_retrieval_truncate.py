...
def main(c: DictConfig) -> None:
    ...
    df_train["prompt"] = df_train["prompt"] + " ## " + df_train["context"]
    df_valid["prompt"] = df_valid["prompt"] + " ## " + df_valid["context"]
    ...
    def preprocess(example):
        ...
        tokenized_example = tokenizer(first_sentence, second_sentences, truncation=True, max_length=cfg.max_length)
